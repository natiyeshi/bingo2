...
const index = () => {
  ...
  return (
    <div className="relative h-[100vh] overflow-hidden ">
        <img src={img} className="absolute left-0 box-content blur-sm -z-40  right-0 top-0 bottom-0" alt="" />
        <nav className='py-4 ps-12'>
            <h1 className='text-xl font-bold'>Dealer</h1>
        </nav>
        <div className='flex'>
            
          <form className="flex shadow-xl relative mx-auto flex-col mt-5 gap-2 bg-white  rounded-xl px-32 py-5" onSubmit={(e) => e.preventDefault()}>
